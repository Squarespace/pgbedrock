...
def test_configure_defaults_to_check_mode(cursor, spec_with_new_user, db_config):
...
def test_configure_live_mode_works(cursor, spec_with_new_user, db_config, live_mode, expected):
    """
